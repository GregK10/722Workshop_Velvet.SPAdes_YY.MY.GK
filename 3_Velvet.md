...
##### stats.txt
    -a tab-separated table with statistics on the contigs
##### Sequences
    -contains the sequences we put in
##### Roadmaps
    -contains the index you just created
##### Log
    -has a useful reminder of what commands you typed to get this assembly result
