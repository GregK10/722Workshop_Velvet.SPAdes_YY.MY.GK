...
- ```--pe1-1 [file]``` is the file with left reads for paired-end library number, in this case ```B4546_1s.fastq```
- ```--pe1-2 [file]``` is the file with right reads for paired-end library number, in this case ```B4546_2s.fastq```
